...
tiff(paste(plot_directory, "barplot_reads.tiff", split = ""),res=300,w=4000,h=2000)
...
tiff(paste(plot_directory, "barplot_clones.tiff", split = ""),res=300,w=4000,h=2000)
...
tiff(paste(plot_directory, "barplot_SHM.tiff", split = ""),res=300,w=4000,h=2000)
barplot(summary_data$SHM,col=COLOR[summary_data$sample],
        names.arg = summary_data$pairs,main="SHM",xlab = "Samples", ylab = "SHM",las=2)
legend("topright", legend=levels(summary_data$sample),col=COLOR[factor(summary_data$sample)],pch=15, cex=0.8)
dev.off()

tiff(paste(plot_directory, "barplot_cdr3length.tiff", split = ""),res=300,w=4000,h=2000)
...
tiff(paste(plot_directory, "entropy.tiff", split = ""),res=300,w=4000,h=2000)
...
tiff(paste(plot_directory, "simpson.tiff", split = ""),res=300,w=4000,h=2000)
...
tiff(paste(plot_directory, "clonality.tiff", split = ""),res=300,w=4000,h=2000)
