...
###
### Author: Brian Le
### Date: June, 2019/Users/ble1/Box Sync/Fetal_Maternal_BCR_TCR_Sirota_Boyd_MacKenzie
############################################################################################

#Run once to combine data files together and save as R workspace

##Read all the files and save into and Rdata all together
directory <- "/Users/ble1/Box Sync/Fetal_Maternal_BCR_TCR_Sirota_Boyd_MacKenzie/TCR_preT_and_cntrls/"
