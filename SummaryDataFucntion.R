...
### PROCESS: 
###           
### DESCRIP: Function to build the summary data
###         
###
...
##Function to build the summary data
summaryData<-function(data_qc){
  ...
  reads_clones_igh_SHM<-cbind(reads_clones_igh,sum_SHM_unmapped$x[id_unmapped],sum_SHM_IGHA$x[id_IGHA],sum_SHM_IGHD$x[id_IGHD],
                            sum_SHM_IGHE$x[id_IGHE],sum_SHM_IGHG$x[id_IGHG],sum_SHM_IGHM$x[id_IGHM])
  colnames(reads_clones_igh_SHM)[14:19]<-c("SHM_unmapped","SHM_IGHA","SHM_IGHD","SHM_IGHE","SHM_IGHG","SHM_IGHM")
  ...
  reads_clones_igh_SHM_cdr3length<-cbind(reads_clones_igh_SHM,cdr3_length_unmapped$x[id_unmapped],cdr3_length_IGHA$x[id_IGHA],cdr3_length_IGHD$x[id_IGHD],
                                       cdr3_length_IGHE$x[id_IGHE],cdr3_length_IGHG$x[id_IGHG],cdr3_length_IGHM$x[id_IGHM])
  colnames(reads_clones_igh_SHM_cdr3length)[20:25]<-c("CDR3_length_unmapped","CDR3_length_IGHA","CDR3_length_IGHD","CDR3_length_IGHE","CDR3_length_IGHG","CDR3_length_IGHM")
  #
  ...
  colnames(reads_clones_igh_SHM_cdr3length_naive_memory)[28:29]<-c("clones_memory","clones_naive")
  ...
  for (i in 1:length(sample)){
    ...
    clones_specimen_unmapped<-data_sample_unique[which(data_sample_unique$isotype==""),"V_J_lenghCDR3_Clone_igh"]
