...
summaryData<-function(data_qc){
  ...
  summary_data$pairs[id]<-as.character(info_samples$Pairs)
  ...
  diversity<-cbind(entropy_IGHA,entropy_IGHD,entropy_IGHE,entropy_IGHG,entropy_IGHM,entropy_naive,entropy_memory,
