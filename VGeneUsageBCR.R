...
data_qc_clones<-data_qc[,c("sample_label", "isotype", "V_J_lenghCDR3_Clone_igh", "v_gene", "v_gene_family")]
...
for (isotype in isotypes){
  ...
  plot_directory_iso <- paste(plot_directory, isotype, "/cutoff500/", sep = "")
  dir.create(plot_directory_iso)
...
for (isotype in isotypes){
  ...
  plot_directory_iso <- paste(plot_directory, isotype, "/cutoff100/", sep = "")
  dir.create(plot_directory_iso)
