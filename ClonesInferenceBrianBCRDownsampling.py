...
def ProcessSample(data_clonesInference_sample_unique, min_read_depth):
    result = pd.DataFrame([])
...
for i in range(0,len(sample_unique)):
    ...
    final_result = ProcessSample(data_clonesInference_sample_unique, min_read_depth)
